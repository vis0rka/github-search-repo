import { KeyboardArrowUp, KeyboardArrowDown, KeyboardArrowLeft, KeyboardArrowRight, Search, PlaylistAdd } from '@mui/icons-material';
...
export const AddChipsIcon =  PlaylistAdd
